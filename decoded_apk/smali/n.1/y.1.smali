...
.method public constructor <init>(Landroid/widget/EditText;)V
    ...
    invoke-direct {v0, p1}, Lb2/a;-><init>(Landroid/widget/EditText;)V
...
.method public a(I)V
    ...
    iget-object p0, p0, Ln/y;->c:Ljava/lang/Object;

    check-cast p0, Ln/X;

    invoke-static {p0, p1}, Ln/X;->e(Ln/X;I)V
...
.method public b(I)V
    ...
    invoke-static {p0, p1}, Ln/X;->d(Ln/X;I)V
...
.method public c(Landroid/text/method/KeyListener;)Landroid/text/method/KeyListener;
    ...
    invoke-direct {p0, p1}, Lb2/f;-><init>(Landroid/text/method/KeyListener;)V
...
.method public d(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p0, v1}, Ln/y;->f(Z)V
    ...
    invoke-static {v1, p1, v2, p2}, Landroidx/lifecycle/c0;->K(Landroid/content/Context;Landroid/util/AttributeSet;[II)Landroidx/lifecycle/c0;

    move-result-object p1

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Landroidx/lifecycle/c0;->x(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v7, v2}, Ln/y;->g(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    invoke-virtual {p1, v2}, Landroidx/lifecycle/c0;->x(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_4

    invoke-virtual {p0, v1, p2}, Ln/y;->g(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method public e(Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;)Lb2/c;
    .locals 1
    ...
    invoke-direct {v0, p0, p1, p2}, Lb2/c;-><init>(Landroid/widget/EditText;Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;)V
...
.method public f(Z)V
    ...
    iget-boolean v0, p0, Lb2/k;->V:Z

    if-eq v0, p1, :cond_1

    iget-object v0, p0, Lb2/k;->U:Lb2/j;
    ...
    iget-object v1, p0, Lb2/k;->U:Lb2/j;
    ...
    :try_start_0
    iget-object v0, v0, Landroidx/emoji2/text/h;->b:LM/g;

    invoke-virtual {v0, v1}, LM/g;->remove(Ljava/lang/Object;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object p0, p0, Lb2/k;->T:Landroid/widget/EditText;

    invoke-static {p0, p1}, Lb2/k;->a(Landroid/widget/EditText;I)V
...
.method public g(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, Ln/y;->g(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
