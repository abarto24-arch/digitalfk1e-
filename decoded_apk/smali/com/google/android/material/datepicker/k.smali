...
.field public W:Lcom/google/android/material/datepicker/n;

.field public X:Lcom/google/android/material/datepicker/k$a;
...
# virtual methods
.method public final h(Lcom/google/android/material/datepicker/n;)V
    .locals 6
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/k;->W:Lcom/google/android/material/datepicker/n;

    iget-object v0, v0, Lcom/google/android/material/datepicker/r;->d:Lcom/google/android/material/datepicker/b;

    iget-object v0, v0, Lcom/google/android/material/datepicker/b;->T:Lcom/google/android/material/datepicker/n;
    ...
    :cond_1
    iput-object p1, p0, Lcom/google/android/material/datepicker/k;->W:Lcom/google/android/material/datepicker/n;
    ...
    invoke-direct {v0, v1, v2, p0}, LF1/a;-><init>(IILjava/lang/Object;)V
...
.method public final i(Lcom/google/android/material/datepicker/k$a;)V
    .locals 4

    iput-object p1, p0, Lcom/google/android/material/datepicker/k;->X:Lcom/google/android/material/datepicker/k$a;

    sget-object v0, Lcom/google/android/material/datepicker/k$a;->YEAR:Lcom/google/android/material/datepicker/k$a;
    ...
    iget-object v3, p0, Lcom/google/android/material/datepicker/k;->W:Lcom/google/android/material/datepicker/n;
    ...
    invoke-virtual {p1, v3}, Lq2/H;->m0(I)V
    ...
    iget-object p0, p0, Lcom/google/android/material/datepicker/k;->c0:Landroid/view/View;
    ...
    iget-object p1, p0, Lcom/google/android/material/datepicker/k;->W:Lcom/google/android/material/datepicker/n;

    invoke-virtual {p0, p1}, Lcom/google/android/material/datepicker/k;->h(Lcom/google/android/material/datepicker/n;)V
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/google/android/material/datepicker/k;->Y:Lcom/google/android/material/datepicker/c;

    invoke-virtual {p1, p3}, Landroid/view/LayoutInflater;->cloneInContext(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object p1

    iget-object v0, p0, Lcom/google/android/material/datepicker/k;->V:Lcom/google/android/material/datepicker/b;

    iget-object v0, v0, Lcom/google/android/material/datepicker/b;->T:Lcom/google/android/material/datepicker/n;

    const v1, 0x101020d

    invoke-static {p3, v1}, Lcom/google/android/material/datepicker/l;->n(Landroid/content/Context;I)Z
    ...
    sget v7, Lcom/google/android/material/datepicker/o;->W:I
    ...
    invoke-static {p2, v2}, LI1/X;->h(Landroid/view/View;LI1/b;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/k;->V:Lcom/google/android/material/datepicker/b;

    iget v2, v2, Lcom/google/android/material/datepicker/b;->X:I
    ...
    invoke-virtual {v0, p2}, Landroidx/recyclerview/widget/RecyclerView;->setLayoutManager(Lq2/H;)V
    ...
    invoke-direct {p2, p3, v0, v2}, Lcom/google/android/material/datepicker/r;-><init>(Landroid/view/ContextThemeWrapper;Lcom/google/android/material/datepicker/b;Lb2/i;)V

    iget-object v0, p0, Lcom/google/android/material/datepicker/k;->a0:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v0, p2}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Lq2/A;)V
    ...
    iput-object v3, p0, Lcom/google/android/material/datepicker/k;->Z:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-virtual {v3, v4}, Landroidx/recyclerview/widget/RecyclerView;->setLayoutManager(Lq2/H;)V
    ...
    invoke-virtual {v0, v3}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Lq2/A;)V
    ...
    invoke-virtual {v0, v3}, Landroidx/recyclerview/widget/RecyclerView;->g(Lq2/F;)V
    ...
    invoke-direct {v3, v4, p0}, LG7/d;-><init>(ILjava/lang/Object;)V

    invoke-static {v0, v3}, LI1/X;->h(Landroid/view/View;LI1/b;)V
    ...
    iput-object v2, p0, Lcom/google/android/material/datepicker/k;->d0:Landroid/view/View;
    ...
    iput-object v2, p0, Lcom/google/android/material/datepicker/k;->e0:Landroid/view/View;

    sget-object v2, Lcom/google/android/material/datepicker/k$a;->DAY:Lcom/google/android/material/datepicker/k$a;

    invoke-virtual {p0, v2}, Lcom/google/android/material/datepicker/k;->i(Lcom/google/android/material/datepicker/k$a;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/k;->a0:Landroidx/recyclerview/widget/RecyclerView;

    new-instance v3, Lcom/google/android/material/datepicker/i;

    invoke-direct {v3, p0, p2, v0}, Lcom/google/android/material/datepicker/i;-><init>(Lcom/google/android/material/datepicker/k;Lcom/google/android/material/datepicker/r;Lcom/google/android/material/button/MaterialButton;)V

    invoke-virtual {v2, v3}, Landroidx/recyclerview/widget/RecyclerView;->h(Lq2/K;)V

    new-instance v2, Lcom/google/android/material/datepicker/j;

    const/4 v3, 0x0

    invoke-direct {v2, v3, p0}, Lcom/google/android/material/datepicker/j;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v0, v2}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v0, p0, Lcom/google/android/material/datepicker/k;->c0:Landroid/view/View;
    ...
    iget-object v0, p0, Lcom/google/android/material/datepicker/k;->b0:Landroid/view/View;
    ...
    new-instance p3, Lq2/w;

    invoke-direct {p3}, Lq2/w;-><init>()V

    iget-object v0, p0, Lcom/google/android/material/datepicker/k;->a0:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v1, p3, Lq2/w;->a:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :cond_4
    iget-object v2, p3, Lq2/w;->b:Lq2/a0;

    if-eqz v1, :cond_6

    iget-object v1, v1, Landroidx/recyclerview/widget/RecyclerView;->Z0:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v3}, Landroidx/recyclerview/widget/RecyclerView;->setOnFlingListener(Lq2/J;)V

    :cond_6
    iput-object v0, p3, Lq2/w;->a:Landroidx/recyclerview/widget/RecyclerView;

    if-eqz v0, :cond_8

    invoke-virtual {v0}, Landroidx/recyclerview/widget/RecyclerView;->getOnFlingListener()Lq2/J;

    move-result-object v0

    if-nez v0, :cond_7

    iget-object v0, p3, Lq2/w;->a:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v0, v2}, Landroidx/recyclerview/widget/RecyclerView;->h(Lq2/K;)V

    iget-object v0, p3, Lq2/w;->a:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v0, p3}, Landroidx/recyclerview/widget/RecyclerView;->setOnFlingListener(Lq2/J;)V
    ...
    :cond_8
    :goto_2
    iget-object p3, p0, Lcom/google/android/material/datepicker/k;->a0:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v0, p0, Lcom/google/android/material/datepicker/k;->W:Lcom/google/android/material/datepicker/n;

    iget-object p2, p2, Lcom/google/android/material/datepicker/r;->d:Lcom/google/android/material/datepicker/b;

    iget-object p2, p2, Lcom/google/android/material/datepicker/b;->T:Lcom/google/android/material/datepicker/n;
    ...
    iget-object p0, p0, Lcom/google/android/material/datepicker/k;->a0:Landroidx/recyclerview/widget/RecyclerView;

    new-instance p2, LO1/h;

    const/4 p3, 0x2

    invoke-direct {p2, p3}, LO1/h;-><init>(I)V

    invoke-static {p0, p2}, LI1/X;->h(Landroid/view/View;LI1/b;)V
...
.method public final onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object p0, p0, Lcom/google/android/material/datepicker/k;->W:Lcom/google/android/material/datepicker/n;
