...
.field public final t0:Lcom/google/android/material/timepicker/c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v2, p0, Lcom/google/android/material/timepicker/ClockFaceView;->p0:Landroid/graphics/Rect;

    new-instance v2, Landroid/graphics/RectF;

    invoke-direct {v2}, Landroid/graphics/RectF;-><init>()V

    iput-object v2, p0, Lcom/google/android/material/timepicker/ClockFaceView;->q0:Landroid/graphics/RectF;

    new-instance v2, Landroid/graphics/Rect;

    invoke-direct {v2}, Landroid/graphics/Rect;-><init>()V

    iput-object v2, p0, Lcom/google/android/material/timepicker/ClockFaceView;->r0:Landroid/graphics/Rect;

    new-instance v2, Landroid/util/SparseArray;

    invoke-direct {v2}, Landroid/util/SparseArray;-><init>()V

    iput-object v2, p0, Lcom/google/android/material/timepicker/ClockFaceView;->s0:Landroid/util/SparseArray;
    ...
    iput-object v3, p0, Lcom/google/android/material/timepicker/ClockFaceView;->v0:[F

    sget-object v3, LA7/a;->c:[I
    ...
    invoke-static {p1, p2, v1}, Ls7/k;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v4

    iput-object v4, p0, Lcom/google/android/material/timepicker/ClockFaceView;->C0:Landroid/content/res/ColorStateList;
    ...
    iput-object v5, p0, Lcom/google/android/material/timepicker/ClockFaceView;->o0:Lcom/google/android/material/timepicker/ClockHandView;
    ...
    iput v6, p0, Lcom/google/android/material/timepicker/ClockFaceView;->w0:I
    ...
    iput-object v4, p0, Lcom/google/android/material/timepicker/ClockFaceView;->u0:[I

    iget-object v4, v5, Lcom/google/android/material/timepicker/ClockHandView;->V:Ljava/util/ArrayList;

    invoke-virtual {v4, p0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    const v4, 0x7f0602a7

    invoke-static {p1, v4}, Ls7/L3;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2, v5}, Ls7/k;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    iput-object p1, p0, Lcom/google/android/material/timepicker/ClockFaceView;->t0:Lcom/google/android/material/timepicker/c;

    new-array p1, v0, [Ljava/lang/String;

    const/4 p2, 0x0

    sget-object p2, Lkb/cDK/PCurHeFEBsFJcM;->ofuoCRjdxIbV:Ljava/lang/String;
    ...
    iget-object v8, p0, Lcom/google/android/material/timepicker/ClockFaceView;->A0:[Ljava/lang/String;
    ...
    :cond_3
    iget-object v8, p0, Lcom/google/android/material/timepicker/ClockFaceView;->t0:Lcom/google/android/material/timepicker/c;

    invoke-static {v7, v8}, LI1/X;->h(Landroid/view/View;LI1/b;)V

    iget-object v8, p0, Lcom/google/android/material/timepicker/ClockFaceView;->C0:Landroid/content/res/ColorStateList;
    ...
    :cond_4
    iget-object p1, p0, Lcom/google/android/material/timepicker/ClockFaceView;->o0:Lcom/google/android/material/timepicker/ClockHandView;

    iget-boolean p2, p1, Lcom/google/android/material/timepicker/ClockHandView;->U:Z

    if-eqz p2, :cond_5

    if-nez v6, :cond_5

    iput v1, p1, Lcom/google/android/material/timepicker/ClockHandView;->i0:I

    :cond_5
    iput-boolean v6, p1, Lcom/google/android/material/timepicker/ClockHandView;->U:Z
...
.method public final f()V
    ...
    invoke-virtual {v0, p0}, Lr1/o;->b(Landroidx/constraintlayout/widget/ConstraintLayout;)V
    ...
    iget v3, p0, Lcom/google/android/material/timepicker/e;->m0:I
    ...
    iget-object v9, v0, Lr1/o;->c:Ljava/util/HashMap;
    ...
    new-instance v11, Lr1/j;

    invoke-direct {v11}, Lr1/j;-><init>()V
    ...
    iget-object v8, v8, Lr1/j;->d:Lr1/k;

    iput v5, v8, Lr1/k;->w:I

    iput v3, v8, Lr1/k;->x:I

    iput v7, v8, Lr1/k;->y:F
    ...
    :cond_8
    invoke-virtual {v0, p0}, Lr1/o;->a(Landroidx/constraintlayout/widget/ConstraintLayout;)V

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Landroidx/constraintlayout/widget/ConstraintLayout;->setConstraintSet(Lr1/o;)V
...
.method public final g()V
    ...
    iget-object v1, v0, Lcom/google/android/material/timepicker/ClockFaceView;->o0:Lcom/google/android/material/timepicker/ClockHandView;

    iget-object v1, v1, Lcom/google/android/material/timepicker/ClockHandView;->c0:Landroid/graphics/RectF;
    ...
    :goto_0
    iget-object v7, v0, Lcom/google/android/material/timepicker/ClockFaceView;->s0:Landroid/util/SparseArray;

    invoke-virtual {v7}, Landroid/util/SparseArray;->size()I

    move-result v8

    iget-object v9, v0, Lcom/google/android/material/timepicker/ClockFaceView;->q0:Landroid/graphics/RectF;

    iget-object v10, v0, Lcom/google/android/material/timepicker/ClockFaceView;->p0:Landroid/graphics/Rect;
    ...
    iget-object v8, v0, Lcom/google/android/material/timepicker/ClockFaceView;->r0:Landroid/graphics/Rect;
    ...
    iget-object v15, v0, Lcom/google/android/material/timepicker/ClockFaceView;->u0:[I

    iget-object v11, v0, Lcom/google/android/material/timepicker/ClockFaceView;->v0:[F
