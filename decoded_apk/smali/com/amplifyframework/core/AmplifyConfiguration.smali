...
.method public synthetic constructor <init>(Ljava/util/Map;Ljava/util/Map;ZI)V
    .locals 0
...
.method public static builder(Lorg/json/JSONObject;)Lcom/amplifyframework/core/AmplifyConfiguration$Builder;
    ...
    invoke-direct {v0, v1, p0}, Lcom/amplifyframework/core/AmplifyConfiguration$Builder;-><init>(ILjava/util/Map;)V
...
.method private static configsFromJson(Lorg/json/JSONObject;)Ljava/util/Map;
    ...
    new-instance v0, Lcom/amplifyframework/analytics/AnalyticsCategoryConfiguration;

    invoke-direct {v0}, Lcom/amplifyframework/analytics/AnalyticsCategoryConfiguration;-><init>()V
    ...
    new-instance v2, Lcom/amplifyframework/auth/AuthCategoryConfiguration;

    invoke-direct {v2}, Lcom/amplifyframework/auth/AuthCategoryConfiguration;-><init>()V

    new-instance v3, Lcom/amplifyframework/datastore/DataStoreCategoryConfiguration;

    invoke-direct {v3}, Lcom/amplifyframework/datastore/DataStoreCategoryConfiguration;-><init>()V

    new-instance v4, Lcom/amplifyframework/geo/GeoCategoryConfiguration;

    invoke-direct {v4}, Lcom/amplifyframework/geo/GeoCategoryConfiguration;-><init>()V

    new-instance v5, Lcom/amplifyframework/hub/HubCategoryConfiguration;

    invoke-direct {v5}, Lcom/amplifyframework/hub/HubCategoryConfiguration;-><init>()V

    new-instance v6, Lcom/amplifyframework/logging/LoggingCategoryConfiguration;

    invoke-direct {v6}, Lcom/amplifyframework/logging/LoggingCategoryConfiguration;-><init>()V

    new-instance v7, Lcom/amplifyframework/predictions/PredictionsCategoryConfiguration;

    invoke-direct {v7}, Lcom/amplifyframework/predictions/PredictionsCategoryConfiguration;-><init>()V

    new-instance v8, Lcom/amplifyframework/storage/StorageCategoryConfiguration;

    invoke-direct {v8}, Lcom/amplifyframework/storage/StorageCategoryConfiguration;-><init>()V

    new-instance v9, Lcom/amplifyframework/notifications/NotificationsCategoryConfiguration;

    invoke-direct {v9}, Lcom/amplifyframework/notifications/NotificationsCategoryConfiguration;-><init>()V

    const/16 v10, 0xa

    new-array v10, v10, [Lcom/amplifyframework/core/category/CategoryConfiguration;
...
.method public forCategoryType(Lcom/amplifyframework/core/category/CategoryType;)Lcom/amplifyframework/core/category/CategoryConfiguration;
    ...
    iget-object p0, p0, Lcom/amplifyframework/core/AmplifyConfiguration;->categoryConfigurations:Ljava/util/Map;
    ...
    check-cast p0, Lcom/amplifyframework/core/category/CategoryConfiguration;
...
.method public getPlatformVersions()Ljava/util/Map;
    ...
    iget-object p0, p0, Lcom/amplifyframework/core/AmplifyConfiguration;->platformVersions:Ljava/util/Map;
...
.method public isDevMenuEnabled()Z
    ...
    iget-boolean p0, p0, Lcom/amplifyframework/core/AmplifyConfiguration;->devMenuEnabled:Z
