...
.method private getPluginIfConfiguredOrThrow(Lcom/amplifyframework/core/plugin/Plugin;)Lcom/amplifyframework/core/plugin/Plugin;
    ...
    iget-object p0, p0, Lcom/amplifyframework/core/category/Category;->categoryInitializationResult:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {p0}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/amplifyframework/core/category/CategoryInitializationResult;

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Lcom/amplifyframework/core/category/CategoryInitializationResult;->getPluginInitializationFailures()Ljava/util/Map;
    ...
    const-string v0, "Failed to get plugin because initialization previously failed.  See attached exception for details."
    ...
    const-string p1, "Tried to get a plugin before it was configured.  Make sure you call Amplify.configure() first."
    ...
    const-string p1, "Failed to get plugin because configuration previously failed.  Check for failures by logging any exceptions thrown by Amplify.configure()."
    ...
    const-string p1, "Tried to get a plugin but that plugin was not present. Check if the plugin was added originally or perhaps was already removed."
...
.method public final addPlugin(Lcom/amplifyframework/core/plugin/Plugin;)V
    ...
    iget-object p0, p0, Lcom/amplifyframework/core/category/Category;->plugins:Ljava/util/Map;
    ...
    const-string p0, " has already been configured or is configuring."
    ...
    const-string v0, "Make sure that you have added all plugins before attempting configuration."
...
.method public declared-synchronized configure(Lcom/amplifyframework/core/category/CategoryConfiguration;Landroid/content/Context;)V
    ...
    .line 2
    :try_start_1
    sget-object v2, Lcom/amplifyframework/core/category/Category$State;->NOT_CONFIGURED:Lcom/amplifyframework/core/category/Category$State;

    iget-object v3, p0, Lcom/amplifyframework/core/category/Category;->state:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 5
    invoke-virtual {p0}, Lcom/amplifyframework/core/category/Category;->configureFromDefaultConfigFile()Z
    ...
    const-string v0, " has already been configured or is currently configuring."
    ...
    const-string v0, "Ensure that you are only attempting configuration once."

    invoke-direct {p1, p2, v0}, Lcom/amplifyframework/AmplifyException;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public declared-synchronized configure(Lcom/amplifyframework/core/configuration/AmplifyOutputsData;Landroid/content/Context;)V
    ...
    .line 22
    invoke-interface {v2, p1, p2}, Lcom/amplifyframework/core/plugin/Plugin;->configure(Lcom/amplifyframework/core/configuration/AmplifyOutputsData;Landroid/content/Context;)V
...
.method public getSelectedPlugin()Lcom/amplifyframework/core/plugin/Plugin;
    ...
    const-string v0, "Tried to get a default plugin but there are more than one to choose from in this category. Call getPlugin(pluginKey) to choose the specific plugin you want to use in this case."
...
.method public declared-synchronized initialize(Landroid/content/Context;)Lcom/amplifyframework/core/category/CategoryInitializationResult;
    .locals 5
...
.method public declared-synchronized isConfigured()Z
    ...
    :try_start_0
    sget-object v0, Lcom/amplifyframework/core/category/Category$State;->CONFIGURED:Lcom/amplifyframework/core/category/Category$State;

    sget-object v1, Lcom/amplifyframework/core/category/Category$State;->INITIALIZING:Lcom/amplifyframework/core/category/Category$State;
    ...
    filled-new-array {v0, v1, v2}, [Lcom/amplifyframework/core/category/Category$State;
