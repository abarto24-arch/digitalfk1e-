...
.method private getEnvironmentInfo()Landroid/text/SpannableStringBuilder;
    ...
    invoke-virtual {v1, p0}, Lcom/amplifyframework/devmenu/EnvironmentInfo;->getDeveloperEnvironmentInfo(Landroid/content/Context;)Ljava/lang/String;
    ...
    :catch_0
    sget-object p0, Lcom/amplifyframework/devmenu/DevMenuEnvironmentFragment;->LOG:Lcom/amplifyframework/logging/Logger;

    const-string v1, "Error reading developer environment information."

    invoke-interface {p0, v1}, Lcom/amplifyframework/logging/Logger;->warn(Ljava/lang/String;)V
