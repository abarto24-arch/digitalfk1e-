.class public final Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase;
...
.method public constructor <init>(Ly5/c;Lcom/amplifyframework/auth/cognito/usecases/FetchAuthSessionUseCase;Lcom/amplifyframework/auth/cognito/AuthStateMachine;)V
    ...
    iput-object p1, p0, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase;->client:Ly5/c;

    iput-object p2, p0, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase;->fetchAuthSession:Lcom/amplifyframework/auth/cognito/usecases/FetchAuthSessionUseCase;

    iput-object p3, p0, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase;->stateMachine:Lcom/amplifyframework/auth/cognito/AuthStateMachine;
...
# virtual methods
.method public final execute(Ljava/lang/String;Lcom/amplifyframework/auth/options/AuthDeleteWebAuthnCredentialOptions;LW9/d;)Ljava/lang/Object;
    .locals 17
    ...
    instance-of v2, v1, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;

    if-eqz v2, :cond_0

    move-object v2, v1

    check-cast v2, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;

    iget v3, v2, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;->label:I
    ...
    iput v3, v2, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;->label:I

    goto :goto_0

    :cond_0
    new-instance v2, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;

    invoke-direct {v2, v0, v1}, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;-><init>(Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase;LW9/d;)V

    :goto_0
    iget-object v1, v2, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;->result:Ljava/lang/Object;

    sget-object v3, LX9/a;->COROUTINE_SUSPENDED:LX9/a;

    iget v4, v2, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;->label:I
    ...
    :cond_2
    iget-object v0, v2, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;->L$1:Ljava/lang/Object;

    check-cast v0, Ljava/lang/String;

    iget-object v4, v2, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;->L$0:Ljava/lang/Object;

    check-cast v4, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase;
    ...
    iget-object v1, v0, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase;->stateMachine:Lcom/amplifyframework/auth/cognito/AuthStateMachine;

    iput-object v0, v2, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;->L$0:Ljava/lang/Object;

    move-object/from16 v4, p1

    iput-object v4, v2, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;->L$1:Ljava/lang/Object;

    iput v7, v2, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;->label:I
    ...
    :cond_5
    :goto_1
    iget-object v1, v0, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase;->fetchAuthSession:Lcom/amplifyframework/auth/cognito/usecases/FetchAuthSessionUseCase;

    iput-object v0, v2, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;->L$0:Ljava/lang/Object;

    iput-object v4, v2, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;->L$1:Ljava/lang/Object;

    iput v6, v2, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;->label:I
    ...
    iget-object v4, v4, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase;->client:Ly5/c;
    ...
    invoke-direct {v0, v6}, LC5/b0;-><init>(LB8/c;)V

    const/4 v1, 0x0

    iput-object v1, v2, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;->L$0:Ljava/lang/Object;

    iput-object v1, v2, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;->L$1:Ljava/lang/Object;

    iput v5, v2, Lcom/amplifyframework/auth/cognito/usecases/DeleteWebAuthnCredentialUseCase$execute$1;->label:I
    ...
    const-string v8, "DeleteWebAuthnCredential"
