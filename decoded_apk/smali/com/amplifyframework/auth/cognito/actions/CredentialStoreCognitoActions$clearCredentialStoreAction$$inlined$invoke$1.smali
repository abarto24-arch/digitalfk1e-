.class public final Lcom/amplifyframework/auth/cognito/actions/CredentialStoreCognitoActions$clearCredentialStoreAction$$inlined$invoke$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/amplifyframework/auth/cognito/actions/CredentialStoreCognitoActions;->clearCredentialStoreAction(Lcom/amplifyframework/statemachine/codegen/data/CredentialType;)Lcom/amplifyframework/statemachine/Action;
.end annotation
...
.method public constructor <init>(Ljava/lang/String;Lcom/amplifyframework/statemachine/codegen/data/CredentialType;)V
    ...
    iput-object p2, p0, Lcom/amplifyframework/auth/cognito/actions/CredentialStoreCognitoActions$clearCredentialStoreAction$$inlined$invoke$1;->$credentialType$inlined:Lcom/amplifyframework/statemachine/codegen/data/CredentialType;
    ...
    :cond_0
    iput-object p1, p0, Lcom/amplifyframework/auth/cognito/actions/CredentialStoreCognitoActions$clearCredentialStoreAction$$inlined$invoke$1;->id:Ljava/lang/String;
...
.method public execute(Lcom/amplifyframework/statemachine/EventDispatcher;Lcom/amplifyframework/statemachine/Environment;LW9/d;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/amplifyframework/auth/cognito/actions/CredentialStoreCognitoActions$clearCredentialStoreAction$$inlined$invoke$1;->getId()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v2, p0, Lcom/amplifyframework/auth/cognito/actions/CredentialStoreCognitoActions$clearCredentialStoreAction$$inlined$invoke$1;->$credentialType$inlined:Lcom/amplifyframework/statemachine/codegen/data/CredentialType;
    ...
    invoke-virtual {p0}, Lcom/amplifyframework/auth/cognito/data/AWSCognitoAuthCredentialStore;->deleteCredential()V
    ...
    iget-object p0, p0, Lcom/amplifyframework/auth/cognito/actions/CredentialStoreCognitoActions$clearCredentialStoreAction$$inlined$invoke$1;->$credentialType$inlined:Lcom/amplifyframework/statemachine/codegen/data/CredentialType;
    ...
    invoke-virtual {v2, p0}, Lcom/amplifyframework/auth/cognito/data/AWSCognitoAuthCredentialStore;->deleteDeviceKeyCredential(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/amplifyframework/auth/cognito/data/AWSCognitoAuthCredentialStore;->deleteASFDevice()V

    :cond_2
    :goto_0
    new-instance p0, Lcom/amplifyframework/statemachine/codegen/events/CredentialStoreEvent;

    new-instance v2, Lcom/amplifyframework/statemachine/codegen/events/CredentialStoreEvent$EventType$CompletedOperation;
    ...
    invoke-direct {v2, v3}, Lcom/amplifyframework/statemachine/codegen/events/CredentialStoreEvent$EventType$CompletedOperation;-><init>(Lcom/amplifyframework/statemachine/codegen/data/AmplifyCredential;)V

    invoke-direct {p0, v2, v1, v0, v1}, Lcom/amplifyframework/statemachine/codegen/events/CredentialStoreEvent;-><init>(Lcom/amplifyframework/statemachine/codegen/events/CredentialStoreEvent$EventType;Ljava/util/Date;ILkotlin/jvm/internal/f;)V
    :try_end_0
    ...
    invoke-virtual {p0}, Lcom/amplifyframework/statemachine/codegen/events/CredentialStoreEvent;->getType()Ljava/lang/String;
...
.method public getId()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/amplifyframework/auth/cognito/actions/CredentialStoreCognitoActions$clearCredentialStoreAction$$inlined$invoke$1;->id:Ljava/lang/String;
