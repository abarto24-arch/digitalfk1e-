.class public Lcom/amplifyframework/auth/exceptions/InvalidStateException;
...
.method public synthetic constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;ILkotlin/jvm/internal/f;)V
    ...
    .line 2
    const-string p1, "Auth state is an invalid state, cannot process the request."
    ...
    .line 3
    const-string p2, "Operation performed is not a valid operation for the current auth state."
    ...
    .line 4
    :cond_2
    invoke-direct {p0, p1, p2, p3}, Lcom/amplifyframework/auth/exceptions/InvalidStateException;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
