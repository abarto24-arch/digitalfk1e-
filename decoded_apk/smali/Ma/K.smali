...
# static fields
.field public static final X:LMa/K;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LMa/K;->Y:LMa/a;

    new-instance v0, LMa/K;

    invoke-direct {v0}, LMa/K;-><init>()V

    sput-object v0, LMa/K;->X:LMa/K;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, LMa/K;->U:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LMa/K;->T:LSa/e;
...
.method public constructor <init>(LMa/m;)V
    ...
    .line 34
    iput-object p1, p0, LMa/K;->T:LSa/e;
...
.method public constructor <init>(LSa/f;LSa/h;)V
    ...
    iput-object v0, p0, LMa/K;->U:Ljava/util/List;
    ...
    iput-object v5, p0, LMa/K;->U:Ljava/util/List;
    ...
    :cond_3
    :goto_1
    iget-object v5, p0, LMa/K;->U:Ljava/util/List;

    sget-object v6, LMa/J;->b0:LMa/a;
    ...
    .line 21
    iget-object p2, p0, LMa/K;->U:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, LMa/K;->U:Ljava/util/List;
    ...
    iput-object p2, p0, LMa/K;->T:LSa/e;
    ...
    .line 26
    iget-object p1, p0, LMa/K;->U:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, LMa/K;->U:Ljava/util/List;
...
.method public final b()Z
    ...
    :goto_0
    iget-object v3, p0, LMa/K;->U:Ljava/util/List;
...
.method public final c()I
    ...
    :goto_0
    iget-object v2, p0, LMa/K;->U:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p0, LMa/K;->T:LSa/e;
...
.method public final f(LL0/d;)V
    ...
    invoke-virtual {p0}, LMa/K;->c()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, LMa/K;->U:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, LMa/K;->T:LSa/e;
