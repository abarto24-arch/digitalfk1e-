...
.method public constructor <init>(Lhb/l;)V
    ...
    invoke-direct {p0, p1}, Lib/h;-><init>(Lhb/o;)V
...
.method public final c()Lib/w;
    ...
    invoke-virtual {p0}, Lib/b;->i()Lta/f;
    ...
    sget-object v2, Lqa/n;->a:LRa/e;

    invoke-static {v0, v2}, Lqa/h;->b(Lta/f;LRa/e;)Z

    move-result v2

    if-nez v2, :cond_1

    sget-object v2, Lqa/n;->b:LRa/e;
    ...
    :cond_0
    invoke-virtual {p0}, Lib/b;->s()Lqa/h;
...
.method public abstract i()Lta/f;
.end method
...
.method public bridge synthetic u()Lta/i;
    .locals 0
