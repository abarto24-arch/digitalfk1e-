...
# direct methods
.method public constructor <init>(LA2/V;LK3/y;LA2/W;)V
    .locals 1

    const-string v0, "submitOtpSmsEffect"
    ...
    iput-object p1, p0, LK3/p;->a:LA2/V;

    iput-object p2, p0, LK3/p;->b:LK3/y;

    iput-object p3, p0, LK3/p;->c:LA2/W;
...
.method public final a(LG9/b;Ljava/lang/Object;)Ljava/util/List;
    ...
    instance-of v0, p2, LK3/f;

    sget-object v1, LK3/a;->h:LK3/a;

    if-eqz v0, :cond_0

    sget-object p0, LK3/n;->d0:LK3/n;
    ...
    invoke-direct {p0, p2, v0}, LK3/o;-><init>(LK3/m;I)V
    ...
    sget-object p2, LK3/n;->f0:LK3/n;

    invoke-virtual {p1, p2}, LG9/b;->a(Lfa/k;)V

    iget-object p0, p0, LK3/p;->b:LK3/y;
    ...
    :cond_4
    sget-object p2, LK3/n;->h0:LK3/n;

    invoke-virtual {p1, p2}, LG9/b;->a(Lfa/k;)V

    new-instance p1, LK3/b;

    invoke-direct {p1, p0}, LK3/b;-><init>(Ljava/lang/Throwable;)V
    ...
    :cond_6
    instance-of v0, p2, LK3/j;

    iget-object v3, p1, LG9/b;->a:Lkotlin/jvm/internal/m;

    if-eqz v0, :cond_7

    sget-object p2, LK3/n;->j0:LK3/n;
    ...
    iget-object p2, p2, LK3/q;->c:Ljava/lang/String;

    invoke-direct {p1, p2}, Ls4/a;-><init>(Ljava/lang/String;)V

    new-instance p2, LJ3/z;

    iget-object p0, p0, LK3/p;->a:LA2/V;

    iget-object p0, p0, LA2/V;->a:LA2/i0;
    ...
    :cond_a
    instance-of v0, p2, LK3/l;

    if-eqz v0, :cond_b

    sget-object p2, LK3/n;->U:LK3/n;
    ...
    iget-object p2, p2, LK3/q;->a:Lq4/b;

    invoke-direct {p1, p2}, LH3/a;-><init>(Lq4/b;)V

    new-instance p2, LJ3/x;

    iget-object p0, p0, LK3/p;->c:LA2/W;

    iget-object p0, p0, LA2/W;->a:LA2/i0;
    ...
    invoke-direct {p0, p1}, LK3/h;-><init>(Ljava/lang/String;)V
    ...
    sget-object p2, LE3/g;->Landing:LE3/g;

    new-array v1, v3, [Ljava/lang/Object;

    sget-object v2, LK3/n;->b0:LK3/n;
    ...
    :cond_13
    sget-object p0, LK3/n;->X:LK3/n;

    invoke-virtual {p1, p0}, LG9/b;->a(Lfa/k;)V

    check-cast p2, LK3/b;

    iget-object p0, p2, LK3/b;->a:Ljava/lang/Throwable;
