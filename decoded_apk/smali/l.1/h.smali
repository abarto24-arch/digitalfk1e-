...
.method public final a(Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_0
    iget-object p0, p0, Ll/h;->E:Ll/i;

    iget-object p0, p0, Ll/i;->c:Landroid/content/Context;
...
.method public final b(Landroid/view/MenuItem;)V
    ...
    invoke-static {v0, v5, v1}, LW4/a;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v5, v0, Lm/s;->c:LC1/a;
    ...
    invoke-interface {v1, v0}, LC1/a;->a(Lm/o;)LC1/a;
    ...
    invoke-interface {v2, v0}, LC1/a;->setContentDescription(Ljava/lang/CharSequence;)LC1/a;

    goto :goto_7

    :cond_d
    invoke-static {p1, v0}, LI1/q;->h(Landroid/view/MenuItem;Ljava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    invoke-interface {v2, v0}, LC1/a;->setTooltipText(Ljava/lang/CharSequence;)LC1/a;

    goto :goto_8

    :cond_e
    invoke-static {p1, v0}, LI1/q;->m(Landroid/view/MenuItem;Ljava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    invoke-interface {v3, v0, v2}, LC1/a;->setAlphabeticShortcut(CI)Landroid/view/MenuItem;

    goto :goto_9

    :cond_f
    invoke-static {p1, v0, v2}, LI1/q;->g(Landroid/view/MenuItem;CI)Landroid/view/MenuItem;
    ...
    invoke-interface {v3, v0, v2}, LC1/a;->setNumericShortcut(CI)Landroid/view/MenuItem;

    goto :goto_a

    :cond_10
    invoke-static {p1, v0, v2}, LI1/q;->k(Landroid/view/MenuItem;CI)Landroid/view/MenuItem;
    ...
    invoke-interface {v2, v0}, LC1/a;->setIconTintMode(Landroid/graphics/PorterDuff$Mode;)Landroid/view/MenuItem;

    goto :goto_b

    :cond_11
    invoke-static {p1, v0}, LI1/q;->j(Landroid/view/MenuItem;Landroid/graphics/PorterDuff$Mode;)Landroid/view/MenuItem;

    :cond_12
    :goto_b
    iget-object p0, p0, Ll/h;->C:Landroid/content/res/ColorStateList;
    ...
    invoke-interface {p1, p0}, LC1/a;->setIconTintList(Landroid/content/res/ColorStateList;)Landroid/view/MenuItem;

    goto :goto_c

    :cond_13
    invoke-static {p1, p0}, LI1/q;->i(Landroid/view/MenuItem;Landroid/content/res/ColorStateList;)Landroid/view/MenuItem;
