...
.method public static b(Landroid/view/View;LI1/G0;Landroid/graphics/Rect;)LI1/G0;
    .locals 1
...
.method public static j(Landroid/view/View;)LI1/G0;
    .locals 7

    sget-boolean v0, LI1/u0;->d:Z
    ...
    :try_start_0
    sget-object v2, LI1/u0;->a:Ljava/lang/reflect/Field;
    ...
    sget-object v2, LI1/u0;->b:Ljava/lang/reflect/Field;
    ...
    sget-object v3, LI1/u0;->c:Ljava/lang/reflect/Field;
    ...
    invoke-direct {v3}, LI1/w0;-><init>()V
    ...
    invoke-direct {v3}, LI1/v0;-><init>()V
    ...
    invoke-static {v4, v5, v6, v2}, Lz1/c;->b(IIII)Lz1/c;

    move-result-object v2

    invoke-virtual {v3, v2}, LI1/v0;->h(Lz1/c;)V
    ...
    invoke-static {v2, v4, v5, v0}, Lz1/c;->b(IIII)Lz1/c;

    move-result-object v0

    invoke-virtual {v3, v0}, LI1/v0;->f(Lz1/c;)V

    invoke-virtual {v3}, LI1/v0;->b()LI1/G0;

    move-result-object v0

    iget-object v2, v0, LI1/G0;->a:LI1/E0;

    invoke-virtual {v2, v0}, LI1/E0;->r(LI1/G0;)V
    ...
    invoke-virtual {v2, p0}, LI1/E0;->d(Landroid/view/View;)V
    :try_end_0
...
.method public static u(Landroid/view/View;LI1/w;)V
    .locals 2
    ...
    invoke-direct {v0, p0, p1}, LI1/L;-><init>(Landroid/view/View;LI1/w;)V
