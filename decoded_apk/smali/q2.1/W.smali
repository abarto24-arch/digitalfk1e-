...
.method public constructor <init>(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iput-object p1, p0, Lq2/W;->Z:Landroidx/recyclerview/widget/RecyclerView;

    sget-object v0, Landroidx/recyclerview/widget/RecyclerView;->v1:LV1/d;

    iput-object v0, p0, Lq2/W;->W:Landroid/view/animation/Interpolator;

    const/4 v1, 0x0

    iput-boolean v1, p0, Lq2/W;->X:Z

    iput-boolean v1, p0, Lq2/W;->Y:Z
    ...
    iput-object v1, p0, Lq2/W;->V:Landroid/widget/OverScroller;
...
.method public final a(II)V
    ...
    iget-object v0, p0, Lq2/W;->Z:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput v1, p0, Lq2/W;->U:I

    iput v1, p0, Lq2/W;->T:I

    iget-object v1, p0, Lq2/W;->W:Landroid/view/animation/Interpolator;

    sget-object v2, Landroidx/recyclerview/widget/RecyclerView;->v1:LV1/d;

    if-eq v1, v2, :cond_0

    iput-object v2, p0, Lq2/W;->W:Landroid/view/animation/Interpolator;
    ...
    :cond_0
    iget-object v3, p0, Lq2/W;->V:Landroid/widget/OverScroller;
...
.method public final b()V
    ...
    iget-boolean v0, p0, Lq2/W;->X:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lq2/W;->Y:Z
...
.method public final c(IIILandroid/view/animation/BaseInterpolator;)V
    ...
    iget-object v2, p0, Lq2/W;->Z:Landroidx/recyclerview/widget/RecyclerView;
    ...
    sget-object p4, Landroidx/recyclerview/widget/RecyclerView;->v1:LV1/d;

    :cond_4
    iget-object p3, p0, Lq2/W;->W:Landroid/view/animation/Interpolator;

    if-eq p3, p4, :cond_5

    iput-object p4, p0, Lq2/W;->W:Landroid/view/animation/Interpolator;
    ...
    iput-object p3, p0, Lq2/W;->V:Landroid/widget/OverScroller;
...
.method public final run()V
    ...
    iget-object v9, v0, Lq2/W;->Z:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->i0:Lq2/H;
    ...
    iput-boolean v10, v0, Lq2/W;->Y:Z

    const/4 v11, 0x1

    iput-boolean v11, v0, Lq2/W;->X:Z

    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView;->n()V

    iget-object v12, v0, Lq2/W;->V:Landroid/widget/OverScroller;
    ...
    iget v3, v0, Lq2/W;->T:I

    sub-int v3, v1, v3

    iget v4, v0, Lq2/W;->U:I

    sub-int v4, v2, v4

    iput v1, v0, Lq2/W;->T:I

    iput v2, v0, Lq2/W;->U:I
    ...
    iget-object v5, v9, Landroidx/recyclerview/widget/RecyclerView;->j1:[I
    ...
    iget-object v13, v9, Landroidx/recyclerview/widget/RecyclerView;->j1:[I
    ...
    :cond_2
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->h0:Lq2/A;
    ...
    iget-object v3, v9, Landroidx/recyclerview/widget/RecyclerView;->i0:Lq2/H;

    iget-object v3, v3, Lq2/H;->e:Lq2/u;

    if-eqz v3, :cond_5

    iget-boolean v4, v3, Lq2/u;->d:Z

    if-nez v4, :cond_5

    iget-boolean v4, v3, Lq2/u;->e:Z

    if-eqz v4, :cond_5

    iget-object v4, v9, Landroidx/recyclerview/widget/RecyclerView;->X0:Lq2/T;

    invoke-virtual {v4}, Lq2/T;->b()I

    move-result v4

    if-nez v4, :cond_3

    invoke-virtual {v3}, Lq2/u;->h()V

    goto :goto_0

    :cond_3
    iget v5, v3, Lq2/u;->a:I

    if-lt v5, v4, :cond_4

    sub-int/2addr v4, v11

    iput v4, v3, Lq2/u;->a:I

    invoke-virtual {v3, v1, v2}, Lq2/u;->f(II)V
    ...
    :goto_1
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->k0:Ljava/util/ArrayList;
    ...
    :cond_7
    iget-object v7, v9, Landroidx/recyclerview/widget/RecyclerView;->j1:[I
    ...
    :goto_5
    iget-object v2, v9, Landroidx/recyclerview/widget/RecyclerView;->i0:Lq2/H;

    iget-object v2, v2, Lq2/H;->e:Lq2/u;

    if-eqz v2, :cond_10

    iget-boolean v2, v2, Lq2/u;->d:Z
    ...
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->W0:LD9/F;

    iget-object v2, v1, LD9/F;->e:Ljava/lang/Object;
    ...
    :cond_1b
    iput v10, v1, LD9/F;->d:I

    goto :goto_b

    :cond_1c
    :goto_a
    invoke-virtual/range {p0 .. p0}, Lq2/W;->b()V

    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->V0:Lq2/m;

    if-eqz v1, :cond_1d

    invoke-virtual {v1, v9, v15, v14}, Lq2/m;->a(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    iget-boolean v2, v1, Lq2/u;->d:Z

    if-eqz v2, :cond_1e

    invoke-virtual {v1, v10, v10}, Lq2/u;->f(II)V

    :cond_1e
    iput-boolean v10, v0, Lq2/W;->X:Z

    iget-boolean v1, v0, Lq2/W;->Y:Z
