...
.method static constructor <clinit>()V
    ...
    invoke-static {v1, v0}, LKa/g;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    const-string v2, "java/lang/annotation/Annotation.annotationType()Ljava/lang/Class;"

    invoke-static {v0, v2}, LT9/G;->f(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/LinkedHashSet;

    move-result-object v0

    sput-object v0, Lsa/s;->a:Ljava/util/LinkedHashSet;

    sget-object v0, LZa/c;->BOOLEAN:LZa/c;

    sget-object v2, LZa/c;->CHAR:LZa/c;

    filled-new-array {v0, v2}, [LZa/c;
    ...
    invoke-virtual {v3}, LZa/c;->getWrapperFqName()LRa/c;
    ...
    invoke-virtual {v5}, LRa/g;->b()Ljava/lang/String;
    ...
    invoke-virtual {v3}, LZa/c;->getJavaKeywordName()Ljava/lang/String;
    ...
    invoke-virtual {v3}, LZa/c;->getDesc()Ljava/lang/String;
    ...
    invoke-static {v5, v3}, LKa/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v3}, LKa/g;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v3

    invoke-static {v2, v3}, LT9/G;->e(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v6, v3}, LKa/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v9, v8}, LKa/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v8

    invoke-static {v2, v8}, LT9/G;->e(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v7, v3}, LKa/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v3}, LKa/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v2, Lsa/s;->b:Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v2}, LKa/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v3}, LKa/g;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v9, v3}, LKa/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v1, v3}, LKa/g;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v8}, LKa/g;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v10, v8}, LKa/g;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v2, Lsa/s;->c:Ljava/util/LinkedHashSet;

    filled-new-array {v11}, [Ljava/lang/String;

    move-result-object v2

    invoke-static {v1, v2}, LKa/g;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v0}, LKa/g;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    invoke-static {v1, v0}, LT9/G;->e(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v10, v1}, LKa/g;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v0, Lsa/s;->d:Ljava/util/LinkedHashSet;

    sget-object v10, LZa/c;->BOOLEAN:LZa/c;

    sget-object v14, LZa/c;->BYTE:LZa/c;

    sget-object v12, LZa/c;->DOUBLE:LZa/c;

    sget-object v13, LZa/c;->FLOAT:LZa/c;

    sget-object v15, LZa/c;->INT:LZa/c;

    sget-object v16, LZa/c;->LONG:LZa/c;

    sget-object v17, LZa/c;->SHORT:LZa/c;

    move-object v11, v14

    filled-new-array/range {v10 .. v17}, [LZa/c;
    ...
    invoke-virtual {v2}, LZa/c;->getWrapperFqName()LRa/c;
    ...
    invoke-static {v3}, LKa/g;->a([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v2, v3}, LKa/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v2

    invoke-static {v1, v2}, LT9/u;->o(Ljava/util/Collection;Ljava/lang/Iterable;)V
    ...
    invoke-static {v0}, LKa/g;->a([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v7, v0}, LKa/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sget-object v11, LRb/omff/mPOqGs;->rQAlUPHww:Ljava/lang/String;

    const-string v12, "[III"

    const/4 v13, 0x0

    sget-object v13, LG5/glik/UQGS;->BgimTsmnTnPDi:Ljava/lang/String;
    ...
    invoke-static {v1}, LKa/g;->a([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v6, v1}, LKa/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v0, Lsa/s;->e:Ljava/util/LinkedHashSet;
    ...
    invoke-static {v9, v0}, LKa/g;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    sput-object v0, Lsa/s;->f:Ljava/util/LinkedHashSet;
