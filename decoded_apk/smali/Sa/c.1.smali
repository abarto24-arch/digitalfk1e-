...
# virtual methods
.method public final b(Ljava/io/ByteArrayInputStream;LSa/h;)LSa/b;
    .locals 5
    ...
    invoke-direct {v1, p1, v0}, LSa/a;-><init>(Ljava/io/ByteArrayInputStream;I)V

    new-instance p1, LSa/f;

    invoke-direct {p1, v1}, LSa/f;-><init>(Ljava/io/InputStream;)V

    invoke-interface {p0, p1, p2}, LSa/z;->a(LSa/f;LSa/h;)Ljava/lang/Object;
    ...
    :try_start_1
    invoke-virtual {p1, p2}, LSa/f;->a(I)V
    :try_end_1
